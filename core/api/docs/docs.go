...
const docTemplate = `{
    ...
    "components": {
        "schemas": {
            ...
            "apimodel.ChatMessage": {
                ...
                "properties": {
                    "attachments": {
                        ...
                        "items": {
                            "$ref": "#/components/schemas/apimodel.MessageAttachment"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "content": {
                        "$ref": "#/components/schemas/apimodel.MessageContent"
                    },
                    "created_at": {
                    ...
                    "creator": {
                        "description": "The creator identity of the message",
                        "example": "user_xyz",
                        "type": "string"
                    },
                    "id": {
                    ...
                    "modified_at": {
                        "description": "Unix timestamp when the message was last modified",
                        "example": 1705312200,
                        "type": "integer"
                    },
                    "object": {
                    ...
                    "order_id": {
                        "description": "The order ID for pagination cursor",
                    ...
                    "reactions": {
                        ...
                        "description": "Map of emoji to list of user IDs who reacted",
                        "type": "object"
                    },
                    "read": {
            ...
            "apimodel.ChatState": {
                ...
                "properties": {
                    "last_state_id": {
                        "description": "The last state ID",
                        "type": "string"
                    },
                    "mentions": {
                        "$ref": "#/components/schemas/apimodel.UnreadState"
                    },
                    "messages": {
                        "$ref": "#/components/schemas/apimodel.UnreadState"
                    }
            ...
            "apimodel.CheckboxFilterItem": {
                "properties": {
                    ...
                    "condition": {
                        "$ref": "#/components/schemas/apimodel.FilterCondition"
                    },
                    "property_key": {
            ...
            "apimodel.CreateMessageRequest": {
                "properties": {
                    ...
                    "style": {
                        "$ref": "#/components/schemas/apimodel.MessageStyle"
                    },
                    "text": {
            ...
            "apimodel.FileUploadResponse": {
                "properties": {
                    ...
                    "object_id": {
                        "description": "The object ID of the uploaded file",
            ...
            "apimodel.FilterExpression": {
                ...
                "properties": {
                    ...
                    "filters": {
                        ...
                        "items": {
                            "$ref": "#/components/schemas/apimodel.FilterExpression"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "operator": {
                        "$ref": "#/components/schemas/apimodel.FilterOperator"
                    }
                },
                "type": "object"
            },
            "apimodel.FilterItem": {
                "oneOf": [
                    {
                        "$ref": "#/components/schemas/apimodel.TextFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.NumberFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.SelectFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.MultiSelectFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.DateFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.CheckboxFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.FilesFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.UrlFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.EmailFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.PhoneFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.ObjectsFilterItem"
                    },
                    {
                        "$ref": "#/components/schemas/apimodel.EmptyFilterItem"
                    }
                ],
                "type": "object"
            },
            "apimodel.FilterOperator": {
            ...
            "apimodel.MessageAttachment": {
                "properties": {
                    "target": {
                        "description": "The target object ID of the attachment",
                        "example": "bafyreie6n5l5nkbjal37su54cha4coy7qzuhrnajluzv5qd5jvtsrxkequ",
                        "type": "string"
                    },
                    "type": {
                        "$ref": "#/components/schemas/apimodel.AttachmentType"
                    }
                },
                "type": "object"
            },
            "apimodel.MessageContent": {
                "description": "The content of the message",
                "properties": {
                    "marks": {
                        "description": "Text formatting marks",
                        "items": {
                            "$ref": "#/components/schemas/apimodel.TextMark"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "apimodel.MessageResponse": {
                "properties": {
                    "message": {
                        "$ref": "#/components/schemas/apimodel.ChatMessage"
                    }
                },
                "type": "object"
            },
            "apimodel.MessageStyle": {
                "description": "The style of the message text",
                "enum": [
                    "paragraph",
                    "header1",
                    "header2",
                ...
                "x-enum-varnames": [
                    ...
                    "MessageStyleCode",
                    "MessageStyleTitle",
                    "MessageStyleCheckbox",
                    "MessageStyleMarked",
                    "MessageStyleNumbered",
                    "MessageStyleToggle",
                    "MessageStyleDescription",
                    "MessageStyleCallout"
                ]
            },
            "apimodel.MessagesResponse": {
                "properties": {
                    "messages": {
                    ...
                    "state": {
                        "$ref": "#/components/schemas/apimodel.ChatState"
                    }
                },
                "type": "object"
            },
            "apimodel.MultiSelectFilterItem": {
                "properties": {
                    "condition": {
                        "$ref": "#/components/schemas/apimodel.FilterCondition"
                    },
            ...
            "apimodel.ReadMessagesRequest": {
                "properties": {
                    "after_order_id": {
                        "description": "Read from this orderId; if empty, read from the beginning",
                        "example": "",
                        "type": "string"
                    },
                    "before_order_id": {
                        "description": "Read up to this orderId",
                        "example": "!!Xz",
                        "type": "string"
                    },
                    "last_state_id": {
                        "description": "The last state ID from ChatState to prevent race conditions",
                        "example": "6980b7db...",
                        "type": "string"
                    },
                    "type": {
                        "$ref": "#/components/schemas/apimodel.ReadMessagesType"
                    }
                },
                "required": [
                    "before_order_id",
            ...
            "apimodel.ReadMessagesType": {
                "description": "The type of counter to mark as read",
                "enum": [
                    "messages",
                    "mentions",
                    "messages",
                ...
                "type": "string",
                "x-enum-varnames": [
                    "ReadMessagesTypeMessages",
                    "ReadMessagesTypeMentions"
                ]
            },
            "apimodel.SearchMessageResult": {
                "properties": {
                    "chat_id": {
                    ...
                    "highlight_ranges": {
                        "description": "Ranges of highlighted text",
                        "items": {
                            "$ref": "#/components/schemas/apimodel.Range"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "apimodel.SearchMessagesRequest": {
                "properties": {
                    "query": {
            ...
            "apimodel.SearchMessagesResponse": {
                "properties": {
                    "results": {
                        "description": "The search results",
                        "items": {
                            "$ref": "#/components/schemas/apimodel.SearchMessageResult"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "apimodel.TextMark": {
                "properties": {
                    "from": {
                        "description": "Start position of the mark",
                        "example": 0,
                        "type": "integer"
                    },
                    "param": {
                        "description": "Optional parameter (e.g., URL for links)",
                        "type": "string"
                    },
                    "to": {
                        "description": "End position of the mark",
                        "example": 5,
                        "type": "integer"
                    },
                    "type": {
                        "description": "The type of mark (bold, italic, link, etc.)",
                        "example": "bold",
                        "type": "string"
                    }
                },
            ...
            "apimodel.ToggleReactionRequest": {
                "properties": {
                    "emoji": {
            ...
            "apimodel.ToggleReactionResponse": {
                "properties": {
                    "added": {
                        "description": "Whether the reaction was added (true) or removed (false)",
                        "example": true,
                        "type": "boolean"
                    }
                },
            ...
            "apimodel.UnreadState": {
                "description": "Unread state for messages",
                "properties": {
                    "counter": {
                    ...
                    "oldest_order_id": {
                        "description": "Order ID of the oldest unread item",
                        "type": "string"
                    }
                },
                "type": "object"
            },
            "apimodel.UpdateMessageRequest": {
                "properties": {
                    "style": {
                        "$ref": "#/components/schemas/apimodel.MessageStyle"
                    },
    ...
    "paths": {
        ...
        "/v1/spaces/{space_id}/chats/{chat_id}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "The number of items to skip (for offset-based pagination)",
                        "in": "query",
                        "name": "offset",
                        "schema": {
                            "default": 0,
                    ...
                    {
                        "description": "Return messages before this order ID (cursor-based pagination for older messages)",
                        "in": "query",
                    ...
                    {
                        "description": "Return messages after this order ID (cursor-based pagination for newer messages)",
                        "in": "query",
                        "name": "after_order_id",
                        "schema": {
                            "type": "string"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/apimodel.MessagesResponse"
                                }
                            }
                        },
                        "description": "The list of chat messages"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/apimodel.CreateMessageRequest",
                                        "summary": "message",
                ...
                "responses": {
                    "201": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/apimodel.MessageResponse"
                                }
                            }
                        },
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/apimodel.UpdateMessageRequest",
                                        "summary": "message",
                                        "description": "The message updates"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/apimodel.ToggleReactionRequest",
                                        "summary": "reaction",
                                        "description": "The reaction to toggle"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/apimodel.ToggleReactionResponse"
                                }
                            }
                        },
        ...
        "/v1/spaces/{space_id}/chats/{chat_id}/read": {
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/apimodel.ReadMessagesRequest",
                                        "summary": "request",
                                        "description": "The read request specifying the range of messages to mark as read"
                                    }
                                ]
                            }
                        }
        ...
        "/v1/spaces/{space_id}/chats/{chat_id}/search": {
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/apimodel.SearchMessagesRequest",
                                        "summary": "search",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/apimodel.SearchMessagesResponse"
                                }
                            }
                        },
                        "description": "The search results"
        ...
        "/v1/spaces/{space_id}/chats/{chat_id}/subscribe": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Number of initial messages to return",
                        "in": "query",
                        "name": "limit",
                        "schema": {
                            "default": 50,
        ...
        "/v1/spaces/{space_id}/files": {
            "post": {
                ...
                "requestBody": {
                    ...
                    "description": "The file to upload | The type of file (file, image, video, audio, pdf). If not specified, the type is auto-detected."
                },
                "responses": {
                    "201": {
                        "content": {
